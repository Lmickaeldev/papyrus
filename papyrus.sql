...
--
-- Hôte : localhost:3306
-- Généré le : lun. 06 fév. 2023 à 18:28
...
(70010, NULL, '2023-02-06 15:12:42', 120),
(70011, 'commande urgente', '2023-02-06 15:20:08', 540),
(70020, NULL, '2023-02-06 15:20:08', 9120),
(70025, 'commande urgente', '2023-02-06 15:20:08', 9150),
(70210, 'commande cadencée', '2023-02-06 15:20:08', 120),
(70250, 'commande cadencée', '2023-02-06 15:20:08', 8700),
(70300, NULL, '2023-02-06 15:20:08', 9120),
(70620, NULL, '2023-02-06 15:20:08', 540),
(70625, 'commande cadencée', '2023-02-06 15:20:08', 120),
(70629, 'commande cadencée', '2023-02-06 15:20:08', 9180);
...
(8700, 'MEDICIS', '120 rue des plantes 75014', '75014', 'Paris', 'lison', 0),
(9120, 'DISCOBOL', '11 rue des sports', '85100', 'La rue sur Yon', 'Hercule', 8),
(9150, 'DEPANPA', '26 avenue des locomotives', '59987', 'coroncountry', 'Pollux', 5),
...
(70010, 2, 'I105', 2000, '485', 200, '2007-07-05'),
...
(70025, 2, 'I105', 500, '590', 1000, '2007-03-15'),
...
(70629, 2, 'B001', 200, '140', 0, '2007-12-31');
...
('I105', 'Papier 2 ex continu', 75, 5, 2300, 'B100'),
...
--
ALTER TABLE `entcom`
  MODIFY `numcom` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70630;
